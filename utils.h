...
bool lerValor (long long *numero); // Validação robusta para entrada de inteiros grandes, usada apenas para armazenar valor em centavos.
...
void imprimeValor(long long valor); // Função para imprimir valor em reais formatado (R$ 00.000,00).
